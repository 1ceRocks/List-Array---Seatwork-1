...
print(f"{critTitle}{varA}{varB}{varC}{varD}{varE}{varF}{varG}")

time.sleep(1)
varArray = '{intA}'.format(intA = f"\n\033[0;1mList Array:\033[0m \033[33;1m{opt_array}\033[0m")
...
if userInput == 1:
    ...
    opt_array.append(varA_Int); os.system('cls'); print(f"\033[0;36;1mUser \033[0;1mList Array: \033[0;33;1m{opt_array}\033[0m\n")
    ...
    opt_array.insert(varB_idx, varB_Int); os.system('cls'); print(f"\033[0;36;1mUser \033[0;1mList Array: \033[0;33;1m{opt_array}\033[0m\n")
    ...
    opt_array.pop(varC_idx); opt_array.insert(varC_idx, varC_Int); os.system('cls'); print(f"\033[0;36;1mUser \033[0;1mList Array: \033[0;33;1m{opt_array}\033[0m\n")
    ...
    opt_array.remove(varD_idx); os.system('cls'); print(f"\033[0;36;1mUser \033[0;1mList Array: \033[0;33;1m{opt_array}\033[0m\n")
    ...
    if varE_Int == "A":
        opt_array.sort(reverse = False); os.system('cls'); print(f"\033[0;36;1mUser \033[0;1mList Array: \033[0;33;1m{opt_array}\033[0m\n")
    elif varE_Int == "B":
        opt_array.sort(reverse= True); os.system('cls'); print(f"\033[0;36;1mUser \033[0;1mList Array: \033[0;33;1m{opt_array}\033[0m\n")
    ...
    opt_array.extend(varG_Data); os.system('cls'); print(f"\033[0;36;1mUser \033[0;1mList Array: \033[0;33;1m{opt_array}\033[0m\n")